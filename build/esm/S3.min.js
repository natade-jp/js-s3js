 ...
 * @author natade (https://github.com/natade-jp)
 * @license MIT
 */class C{x=0;y=0;constructor(t,e){this._initIDPosition(t,e)}_initIDPosition(t,e){if(t instanceof C){const e=t;this.set(e)}else void 0===t?(this.x=0,this.y=0):2===arguments.length?this.set(t,e):(this.x=0,this.y=0)}clone(){return new C(this)}set(t,e){if(t instanceof C){const e=t;this.x=e.x,this.y=e.y}else this.x=t,this.y=e}add(t,e){if(t instanceof C){const e=t;this.x+=e.x,this.y+=e.y}else this.x+=t,this.y+=e}sub(t,e){if(t instanceof C){const e=t;this.x-=e.x,this.y-=e.y}else this.x-=t,this.y-=e}static norm(t,e){const s=t.x-e.x,i=t.y-e.y;return Math.sqrt(s*s+i*i)}}
/**
 ...
 * @author natade (https://github.com/natade-jp)
 * @license MIT
 */class O{constructor(t){this._initIDDraggableSwitch(t)}_initIDDraggableSwitch(t){this.mask=t,this.switch=new R,this.client=new C,this.deltaBase=new C,this.dragged=new C}clone(){const t=new O(this.mask);return t.switch=this.switch.clone(),t.client=this.client.clone(),t.deltaBase=this.deltaBase.clone(),t.dragged=this.dragged.clone(),t}correctionForDOM(t){let e=t.target;e||(e=t.currentTarget);let s=0,i=0;if("clientX"in t&&"clientY"in t?(s=t.clientX,i=t.clientY):"touches"in t&&t.touches.length>0&&(s=t.touches[0].clientX,i=t.touches[0].clientY),void 0===e)return new C(s,i);{const t=e;let n=t.clientWidth,r=t.clientHeight;return"width"in e&&"number"==typeof e.width&&(n=e.width),"height"in e&&"number"==typeof e.height&&(r=e.height),new C(s/t.clientWidth*n,i/t.clientHeight*r)}}setPosition(t){const e=this.correctionForDOM(t);this.client.set(e),this.deltaBase.set(e),this.dragged._initIDPosition()}mousePressed(t){const e=this.correctionForDOM(t);t.button===this.mask&&(this.switch.ispressed||this.dragged._initIDPosition(),this.switch.keyPressed(),this.client.set(e),this.deltaBase.set(e))}mouseReleased(t){t.button===this.mask&&this.switch.ispressed&&this.switch.keyReleased()}mouseMoved(t){const e=this.correctionForDOM(t);if(this.switch.ispressed){const t=new C(e);t.sub(this.deltaBase),this.dragged.add(t)}this.client.set(e.x,e.y),this.deltaBase.set(e.x,e.y)}focusLost(){this.switch.focusLost()}pickInput(t){if(!(t instanceof O))throw"IllegalArgumentException";this.switch.pickInput(t.switch),t.client.set(this.client),t.dragged.set(this.dragged),this.dragged._initIDPosition()}}
/**
 * IDMouse.js
 *
 * @module InputDetect
