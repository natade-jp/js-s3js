 ...
 * @license MIT
 */
class O{constructor(){this._initIDSwitch()}_initIDSwitch(){this.istyped=!1,this.ispressed=!1,this.isreleased=!1,this.pressed_time=0}clone(){const t=new O;return t.istyped=this.istyped,t.ispressed=this.ispressed,t.isreleased=this.isreleased,t.pressed_time=this.pressed_time,t}keyPressed(){this.ispressed||(this.istyped=!0),this.ispressed=!0,this.pressed_time++}keyReleased(){this.ispressed=!1,this.isreleased=!0,this.pressed_time=0}focusLost(){this.keyReleased()}pickInput(t){if(!(t instanceof O))throw"IllegalArgumentException";t.ispressed=this.ispressed,t.istyped=this.istyped,t.isreleased=this.isreleased,t.pressed_time=this.pressed_time,this.isreleased=!1,this.istyped=!1}}
/**
 * IDPosition.js
 *
 * @module InputDetect
 * @author natade (https://github.com/natade-jp)
 * @license MIT
 */class R{x=0;y=0;constructor(t,e){this._initIDPosition(t,e)}_initIDPosition(t,e){if(t instanceof R){const e=t;this.set(e)}else void 0===t?(this.x=0,this.y=0):2===arguments.length?this.set(t,e):(this.x=0,this.y=0)}clone(){return new R(this)}set(t,e){if(t instanceof R){const e=t;this.x=e.x,this.y=e.y}else this.x=t,this.y=e}add(t,e){if(t instanceof R){const e=t;this.x+=e.x,this.y+=e.y}else this.x+=t,this.y+=e}sub(t,e){if(t instanceof R){const e=t;this.x-=e.x,this.y-=e.y}else this.x-=t,this.y-=e}static norm(t,e){const s=t.x-e.x,i=t.y-e.y;return Math.sqrt(s*s+i*i)}}
/**
 ...
 * @author natade (https://github.com/natade-jp)
 * @license MIT
 */class N{constructor(t){this._initIDDraggableSwitch(t)}_initIDDraggableSwitch(t){this.mask=t,this.switch=new O,this.client=new R,this.deltaBase=new R,this.dragged=new R}clone(){const t=new N(this.mask);return t.switch=this.switch.clone(),t.client=this.client.clone(),t.deltaBase=this.deltaBase.clone(),t.dragged=this.dragged.clone(),t}correctionForDOM(t){let e=t.target;e||(e=t.currentTarget);let s=0,i=0;if("clientX"in t&&"clientY"in t?(s=t.clientX,i=t.clientY):"touches"in t&&t.touches.length>0&&(s=t.touches[0].clientX,i=t.touches[0].clientY),void 0===e)return new R(s,i);{const t=e;let n=t.clientWidth,r=t.clientHeight;return"width"in e&&"number"==typeof e.width&&(n=e.width),"height"in e&&"number"==typeof e.height&&(r=e.height),new R(s/t.clientWidth*n,i/t.clientHeight*r)}}setPosition(t){const e=this.correctionForDOM(t);this.client.set(e),this.deltaBase.set(e),this.dragged._initIDPosition()}mousePressed(t){const e=this.correctionForDOM(t);t.button===this.mask&&(this.switch.ispressed||this.dragged._initIDPosition(),this.switch.keyPressed(),this.client.set(e),this.deltaBase.set(e))}mouseReleased(t){t.button===this.mask&&this.switch.ispressed&&this.switch.keyReleased()}mouseMoved(t){const e=this.correctionForDOM(t);if(this.switch.ispressed){const t=new R(e);t.sub(this.deltaBase),this.dragged.add(t)}this.client.set(e.x,e.y),this.deltaBase.set(e.x,e.y)}focusLost(){this.switch.focusLost()}pickInput(t){if(!(t instanceof N))throw"IllegalArgumentException";this.switch.pickInput(t.switch),t.client.set(this.client),t.dragged.set(this.dragged),this.dragged._initIDPosition()}}
/**
 * IDMouse.js
 *
 * @module InputDetect
 ...
 * @license MIT
 */
class S extends C{constructor(){super(),this._initIDTouch()}_initIDTouch(){this.touchcount_to_mask={1:C.MOUSE_EVENTS.BUTTON1_MASK,2:C.MOUSE_EVENTS.BUTTON3_MASK,3:C.MOUSE_EVENTS.BUTTON2_MASK};const t=this;this._mousePressed=function(e){t.mousePressed(e)},this._mouseReleased=function(e){t.mouseReleased(e)},this._mouseMoved=function(e){t.mouseMoved(e)},this.isdoubletouch=!1,this._doubleposition_p1=null,this._doubleposition_p2=null}_initPosition(t){this.left.setPosition(t),this.right.setPosition(t),this.center.setPosition(t)}_MultiTouchToMouse(t){let e=0,s=0;for(let i=0;i<t.touches.length;i++)e+=t.touches[i].clientX,s+=t.touches[i].clientY;const i={};if(t.touches.length>0){i.clientX=e/t.touches.length,i.clientY=s/t.touches.length,i.button=this.touchcount_to_mask[t.touches.length];const n=t.touches[0];i.target=n.target?n.target:t.currentTarget}else i.clientX=0,i.clientY=0,i.button=0;return i.touchcount=t.touches.length,i}_MoveMultiTouch(t){if(2===t.touches.length){const e=t.touches[0],s=t.touches[1];if(!1===this.isdoubletouch)this.isdoubletouch=!0,this._doubleposition_p1=new R(e.clientX,e.clientY),this._doubleposition_p2=new R(s.clientX,s.clientY);else{const t=new R(e.clientX,e.clientY),i=new R(s.clientX,s.clientY),n=R.norm(this._doubleposition_p1,this._doubleposition_p2)-R.norm(t,i);this._doubleposition_p1=t,this._doubleposition_p2=i;const r=Math.abs(n)<10?.01*Math.abs(n):.5;this.wheelrotation+=(n>0?-1:1)*r}}else this.isdoubletouch}_actFuncMask(t,e,s,i){const n=t;for(const t in C.MOUSE_EVENTS)n.button=C.MOUSE_EVENTS[t],C.MOUSE_EVENTS[t]===i?e(n):s(n)}_touchStart(t){const e=this._MultiTouchToMouse(t);this._initPosition(e),this._actFuncMask(e,this._mousePressed,this._mouseReleased,e.button)}_touchEnd(t){const e=this._MultiTouchToMouse(t);this._actFuncMask(e,this._mouseReleased,this._mouseReleased,e.button)}_touchMove(t){this._MoveMultiTouch(t);const e=this._MultiTouchToMouse(t);this._actFuncMask(e,this._mouseMoved,this._mouseMoved,e.button)}setListenerOnElement(t){super.setListenerOnElement(t);const e=this,s=function(t){e._touchEnd(t)};t.addEventListener("touchstart",(function(t){e._touchStart(t)}),!1),t.addEventListener("touchend",s,!1),t.addEventListener("touchmove",(function(t){e._touchMove(t),t.preventDefault()}),!1),t.addEventListener("touchcancel",s,!1)}}
/**
 * IDTools.js
 *
 * @module InputDetect
 ...
 * @author natade (https://github.com/natade-jp)
 * @license MIT
 */class P{constructor(){this._data=new S}static create(){return new P}setListenerOnElement(t){this._data.setListenerOnElement(t)}pickInput(){const t=new S;return this._data.pickInput(t),t}static noScroll(){F()}}const V={System:d,GLSystem:class extends d{constructor(){super(),this.program=null,this.gl=null,this.is_set=!1,this.program_list=[],this.program_listId=0,this.canvas=null,this._textureDummyId=void 0,this._textureDummyData=void 0;const t=this,e={};this.glfunc={createBufferVBO:function(e){const s=t.getGL();if(null===s)return null;const i=s.createBuffer();return s.bindBuffer(s.ARRAY_BUFFER,i),s.bufferData(s.ARRAY_BUFFER,e,s.STATIC_DRAW),s.bindBuffer(s.ARRAY_BUFFER,null),i},createBufferIBO:function(e){const s=t.getGL();if(null===s)return null;const i=s.createBuffer();return s.bindBuffer(s.ELEMENT_ARRAY_BUFFER,i),s.bufferData(s.ELEMENT_ARRAY_BUFFER,e,s.STATIC_DRAW),s.bindBuffer(s.ELEMENT_ARRAY_BUFFER,null),i},deleteBuffer:function(e){const s=t.getGL();return null===s&&(s.deleteBuffer(e),!0)},createTexture:function(s,i){if(!(i instanceof ImageData||i instanceof HTMLImageElement||i instanceof HTMLCanvasElement||i instanceof HTMLVideoElement))throw"createBufferTexture";const n=t.getGL();if(null===n)return null;let r=null;if(!e[s]){r=n.createTexture(),n.bindTexture(n.TEXTURE_2D,r),n.texImage2D(n.TEXTURE_2D,0,n.RGBA,n.RGBA,n.UNSIGNED_BYTE,i),n.generateMipmap(n.TEXTURE_2D),n.bindBuffer(n.ELEMENT_ARRAY_BUFFER,null);const t={texture:r,count:0};e[s]=t}return r=e[s].texture,e[s].count++,r},deleteTexture:function(s){const i=t.getGL();null!==i&&e[s]&&(e[s].count--,0===e[s].count&&(i.deleteTexture(e[s].texture),delete e[s]))},createProgram:function(e,s){const i=t.getGL();if(null===i)return null;let n=i.createProgram(),r=!1;return i.attachShader(n,e),i.attachShader(n,s),i.linkProgram(n),i.getProgramParameter(n,i.LINK_STATUS)||(console.log("link error "+i.getProgramInfoLog(n)),i.detachShader(n,e),i.detachShader(n,s),i.deleteProgram(n),n=null,r=!0),{program:n,is_error:r}},deleteProgram:function(e,s,i){const n=t.getGL();return null!==n&&(n.detachShader(e,s),n.detachShader(e,i),n.deleteProgram(e),!0)},createShader:function(e,s){const i=t.getGL();if(null===i)return null;let n=i.createShader(e),r=!1;return i.shaderSource(n,s),i.compileShader(n),i.getShaderParameter(n,i.COMPILE_STATUS)||(console.log("compile error "+i.getShaderInfoLog(n)),i.deleteShader(n),n=null,r=!0),{shader:n,is_error:r}},deleteShader:function(e){const s=t.getGL();return null!==s&&(s.deleteShader(e),!0)}}}getGL(){return this.gl}isSetGL(){return null!==this.gl}setCanvas(t){const e=t.getContext("webgl")||t.getContext("experimental-webgl");this.canvas=t,this.gl=e}createProgram(){const t=new T(this,this.program_listId);return this.program_list[this.program_listId]=t,this.program_listId++,t}disposeProgram(){for(const t in this.program_list)this.program_list[t].dispose(),delete this.program_list[t]}setProgram(t){if(null===t)return!1;if(!(t instanceof T))throw new Error("引数がS3GLProgramのインスタンスではありません。");null===this.program&&(this.program=t);return null!==t.getProgram()&&(!(this.program!==t||!this.is_set)||(null!==this.program&&this.program.disuseProgram(),this.program=t,this.program.useProgram(),void(this.is_set=!0)))}clear(){if(null===this.gl)return!1;const t=this.getBackgroundColor();return this.gl.clearColor(t.x,t.y,t.z,t.w),this.gl.clearDepth(1),this.gl.clear(this.gl.COLOR_BUFFER_BIT|this.gl.DEPTH_BUFFER_BIT),!0}drawElements(t){return!!this.is_set&&(this.gl.drawElements(this.gl.TRIANGLES,t,this.gl.UNSIGNED_SHORT,0),this.gl.flush(),!0)}deleteBuffer(t){return null!==this.gl&&(this.gl.deleteBuffer(t),!0)}_getDummyTexture(){if(void 0===this._textureDummyData){const t=document.createElement("canvas");t.width=1,t.height=1;const e=t.getContext("2d").getImageData(0,0,t.width,t.height);this._textureDummyId=this._createID(),this._textureDummyData=this.glfunc.createTexture(this._textureDummyId,e)}return this._textureDummyData}_setDepthMode(){if(null===this.gl)return!1;const t=this.gl;return t.enable(t.DEPTH_TEST),t.depthFunc(t.LEQUAL),!0}_setCullMode(){if(null===this.gl)return!1;const t=this.gl;return this.cullmode===d.CULL_MODE.NONE?(t.disable(t.CULL_FACE),!0):(t.enable(t.CULL_FACE),this.frontface===d.FRONT_FACE.CLOCKWISE?t.frontFace(t.CW):t.frontFace(t.CCW),this.cullmode===d.CULL_MODE.FRONT_AND_BACK?t.cullFace(t.FRONT_AND_BACK):this.cullmode===d.CULL_MODE.BACK?t.cullFace(t.BACK):this.cullmode===d.CULL_MODE.FRONT&&t.cullFace(t.FRONT),!0)}_bindStart(){this.program.resetActiveTextureId()}_bindEnd(){}_bind(){if(!this.is_set)return-1;const t=this.program;let e=0;if(2===arguments.length&&"string"==typeof arguments[0]){if(!t.bindData(arguments[0],arguments[1]))return-1}else if(1===arguments.length&&arguments[0]instanceof v){const s=arguments[0].getMesh();s instanceof w&&(e=t.bindMesh(s))}else if(1===arguments.length&&arguments[0].uniforms){const e=arguments[0].uniforms;for(const s in e)if(!t.bindData(s,e[s]))return-1}return e}drawScene(t){if(this.setProgram(this.program),!this.is_set)return;this._setDepthMode(),this._setCullMode(),this._bindStart(),this._bind(t.getUniforms());const e=t.getCamera().getVPSMatrix(this.canvas),s=t.getModels();for(let t=0;t<s.length;t++){const i=s[t];if(!1===i.getMesh().isComplete())continue;this._bind(i.getUniforms());const n=this.getMatrixWorldTransform(i),r=this.mulMatrix(n,e.LookAt),o=this.mulMatrix(r,e.PerspectiveFov);this._bind("matrixWorldToLocal4",n.inverse4()),this._bind("matrixLocalToWorld4",n),this._bind("matrixLocalToWorld3",n),this._bind("matrixLocalToPerspective4",o);const a=this._bind(i);a&&this.drawElements(a)}this._bindEnd()}_disposeObject(t){}createVertex(t){return new y(t)}createTriangleIndex(t,e,s,i,n,r){return new _(t,e,s,i,n,r)}createTexture(t){return new p(this,t)}createScene(){return new D}createModel(){return new v}createMesh(){return new w(this)}createMaterial(t){return new E(this,t)}createLight(){return new M}createCamera(){return new i(this)}},Math:t,Angles:l,Vector:s,Matrix:e,Plane:class{constructor(t,e){e instanceof s?(this.n=t,this.d=this.n.dot(e)):(this.n=t,this.d=e)}getDistance(t){return t.dot(this.n)-this.d}getNearestPoint(t){return this.n.mul(-this.getDistance(t)).add(t)}isHitPosition(t){return this.getDistance(t)<0}toString(){return"Plane("+this.n.toString()+", ["+this.d+"])"}},SYSTEM_MODE:d.SYSTEM_MODE,DEPTH_MODE:d.DEPTH_MODE,DIMENSION_MODE:d.DIMENSION_MODE,VECTOR_MODE:d.VECTOR_MODE,FRONT_FACE:d.FRONT_FACE,CULL_MODE:d.CULL_MODE,LIGHT_MODE:n.MODE,MeshLoader:A,CameraController:class{constructor(){this.mouse=P.create(),this.moveDistance=4,this.moveRotate=.5,this.moveTranslateRelative=.1,this.camera=null}setCanvas(t){this.mouse.setListenerOnElement(t)}setCamera(t){this.camera=t.clone()}getCamera(){const t=this.mouse.pickInput();this.camera.translateRelative(new s(-t.left.dragged.x*this.moveTranslateRelative,t.left.dragged.y*this.moveTranslateRelative,0)),this.camera.addRotateY(t.right.dragged.x*this.moveRotate),this.camera.addRotateX(-t.right.dragged.y*this.moveRotate);let e=this.camera.getDistance();return e-=t.wheelrotation*this.moveDistance*Math.log(e),this.camera.setDistance(e),this.camera}}};export{V as default};
